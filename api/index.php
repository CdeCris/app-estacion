<?php
	...
	/**
	* @file index.php
	* @brief API Restful para el proyecto ACME
	* @author Matias Leonardo Baez @robado por ACME
	* @date 2024
	* @contact ---
	*/
	...
	$finger_print = md5($_SERVER["REDIRECT_URL"].date("Y-m-d+H:i:s+").mt_rand(0, 5000));
